...
public class ReactionResponseAdapter implements JsonAdapter<ReactionResponse> {
  ...
  static {
    map.put("claim-order", ClaimOrderReactionResponse.class);
    map.put("offer", OfferAcceptReactionResponse.class);
    map.put("review", ReviewReactionResponse.class);
    map.put("ticket-creator", TicketCreatorReactionResponse.class);
    map.put("ticket-panel", TicketPanelReactionResponse.class);
  }
  ...
  public JsonElement serialize(
    ...
    Class<? extends ReactionResponse> aClass = map.get(((BotReactionResponse) src).getType());
  ...
  public ReactionResponse deserialize(
    ...
    Class<? extends ReactionResponse> aClass = map.get(type);
    if (aClass == null) return null;
