...
public class ReviewReactionResponse extends StarfishReactionResponse {
  ...
  private long getFreelancer() {
    return message == null ? -1 : message.getData().getValueOr("freelancer", Long.class, -1L);
  }

  private long getUser() {
    return message == null ? -1 : message.getData().getValueOr("user", Long.class, -1L);
  }
  ...
  public @NonNull String getUnicode() {
    return getUnicode("review." + this.value);
  }
}
