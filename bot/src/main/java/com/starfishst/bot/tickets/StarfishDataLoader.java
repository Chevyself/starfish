...
public class StarfishDataLoader implements Loader {
  ...
  public void ping() {
    this.database.runCommand(new Document("serverStatus", 1));
  }
  ...
  public void onRoleUnloadedEvent(@NonNull BotRoleUnloadedEvent event) {
    ...
    Mongo.save(this.roles(), new Document("id", role.getId()), role);
  }
  ...
  public void onTicketUnloadedEvent(@NonNull TicketUnloadedEvent event) {
    ...
    Mongo.save(this.tickets(), new Document("id", ticket.getId()), ticket);
  }
  ...
  public void onFreelancerRatingUnloaded(@NonNull FreelancerRatingUnloadedEvent event) {
    ...
    Mongo.save(this.ratings(), new Document("id", rating.getId()), rating);
  }
  ...
  public void onBotUserUnloaded(@NonNull BotUserUnloadedEvent event) {
    ...
    Mongo.save(this.users(), new Document("id", user.getId()), user);
  }
  ...
  public void onBotMessageUnloaded(@NonNull BotMessageUnloadedEvent event) {
    ...
    Mongo.save(this.messages(), new Document("id", message.getId()), message);
  }
}
