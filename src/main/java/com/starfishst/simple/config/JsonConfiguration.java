...
public class JsonConfiguration {
     ...
     */
    public static <T extends JsonConfiguration> T getInstance(@NotNull File file, Class<T> clazz) throws FileNotFoundException {
     ...
     * @throws FileNotFoundException in case that the file provided doesn't exist
     */
    public static <T extends JsonConfiguration> T getInstance(@NotNull String name, Class<T> clazz) throws IOException {
