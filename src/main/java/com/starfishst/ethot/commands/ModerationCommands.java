...
public class ModerationCommands {
     ...
     */
    @Command(aliases = "mute", description = "Mute the specified user", permission = Permission.ADMINISTRATOR)
    public Result mute(@Required(name = "user", description = "The user to mute") Member user, @Optional(name = "reason", description = "The reason to mute the user", suggestions = "No reason") JoinedStrings reason) {
        // TODO
        return new Result();
    }
     ...
     */
    @Command(aliases = "unmute", description = "Unmute the specified user", permission = Permission.ADMINISTRATOR)
     ...
     */
    @Command(aliases = "ban", description = "Ban the specified user", permission = Permission.ADMINISTRATOR)
    public Result ban(@Required(name = "user", description = "The user to ban") Member user, @Required(name = "reason", description = "The reason of the ban") JoinedStrings reason){
        // TODO
        return new Result();
    }
     ...
     */
    @Command(aliases = {"unban", "pardon"}, description = "Unban the specified user", permission = Permission.ADMINISTRATOR)
    ...
    public Result clear(TextChannel channel, @Required(name = "amount", description = "The amount of lines to clear") int amount) {
        // TODO
    ...
    public Result blacklist(@Required(name = "user", description = "The user to blacklist") Member user){
        // TODO
        return new Result();
    }
