...
public class Unicode {
  ...
  /**
   * Get an specific emoji. It must have the unicode format provided by services like <a href="https://unicode.org/emoji/charts/full-emoji-list.html">unicode.org</a>
   *
